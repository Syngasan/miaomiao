<template>
  <div class="search_body">
    ...
    <div class="search_result">
      <h3>电影/电视剧/综艺</h3>
      <ul>
        <li v-for="item in moviesList.slice(0,a)" :key="item.id">
          <div class="img">
          ...
          <div class="info">
            <p>
              ...
              <span>{{item.sc===0?"暂无评分":item.sc+"分"}}</span>
            </p>
            <p>{{item.enm}}</p>
            <p>{{item.cat}}</p>
            <p>{{item.pubDesc}}</p>
      ...
      <div class="load-more mr-bottom" v-if="a<=moviesList.length" @click="loadMore">点击加载更多</div>
